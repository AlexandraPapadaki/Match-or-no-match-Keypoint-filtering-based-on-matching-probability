...
int main(int argc, char** argv) {
	...
	// INPUTS *********************************************************************************************
	/// For Pre-training, Training and Testing phase: Amount of features which define the classifier architecture. (8=proposed, 128=Predicting matchability 2014)
	...
	/// For Pre-training phase: Training images folder directory ("Training images" is the default folder for using the provided training images)
	cv::String dirTrainingImages = "Training images";

	/// For Training: Training data folder directory ("Training Data" is the default folder for the provided training data)
	cv::String dirTrainingData = "Training Data";
	...
	/// Pre-training phase
	// Please uncomment the following lines to obtain your own training data. Adjust the directory of your training images in the "dirTrainingImages"
	App::getTrainedData(dirTrainingImages, n_featuresWrtMethod);
	// End of pre-training

	/// Training phase
	// Please uncomment the following lines to apply training. Adjust the directory folder of your training data in the "TestImagesDirectory" and the pretrained model in "trainedModel" the above.
